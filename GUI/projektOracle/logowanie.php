...
<body>
	...
	<div class="dwa text-center">
		...
		<div class="container text-center">
			<label style="font-family: Bradley Hand, cursive; font-size: 25px"><b>Logowanie</b></label>
			<div class="form-group " style="width:30%; margin: 0 auto;">
				<form method="POST">
					<input class="form-control" type="text" placeholder="Nazwa użytkownika:" name="login" required>
			...
			<label style="display: block"><b>Nie masz konta?</b></label>
			<form action="rejestracja.php">
				<button class="btn btn3 btn-lg" type="submit">Zarejestruj się!</button>
			</form>
