...
<div class="collapse navbar-collapse flex-grow-0 ml-auto" id="navbarSupportedContent">
    ...
    <?php 
        ...
        <li class="nav-item">
            <a href="koszyk.php" class="nav-link text-center px-3 py-3 w-100 h-100 mx-auto" style="text-decoration: none;"><span class="dot"><?php 
            if(empty($_SESSION['cart'])) $_SESSION['total']=0;
            else $_SESSION['total']=count($_SESSION['cart']);
            echo $_SESSION['total'];?></span>KOSZYK</a>
            </li>
        <li class="nav-item">
            <a href="kontakt.php" class="nav-link text-center px-3 py-3 w-100 h-100 mx-auto" style="text-decoration: none;">KONTAKT</a>
        </li>
        <li class="nav-item">
